...
class AutosControllerTest < ActionController::TestCase
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post :create, auto: { Año: @auto.Año, Capacidad: @auto.Capacidad, Marca: @auto.Marca, Modelo: @auto.Modelo, Placa: @auto.Placa }
    end
  ...
  test "should update auto" do
    patch :update, id: @auto, auto: { Año: @auto.Año, Capacidad: @auto.Capacidad, Marca: @auto.Marca, Modelo: @auto.Modelo, Placa: @auto.Placa }
    assert_redirected_to auto_path(assigns(:auto))
  end
